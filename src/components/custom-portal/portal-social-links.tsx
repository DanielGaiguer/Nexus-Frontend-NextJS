...
/* Ícones de marca — o lucide desta versão não os traz, então SVG inline
   (paths do Simple Icons, viewBox 24, fill currentColor). */
...
/** Barra de ícones de redes sociais para o rodapé da página pública. Nada se
 *  nenhum link estiver configurado. Cor vem do branding (inline). */
export function PortalSocialLinksBar({
  links,
  color,
}: {
  links: PortalSocialLinks | null | undefined;
  color: string;
}) {
